...
// By Nathan Chantrell. 
//
// Using the TinyTX as a receiver for the TinyTX_Reed Sensor
...
// Fixed RF12 settings
#define MYNODE 23            //node ID of the receiever
#define freq RF12_433MHZ     //frequency
#define group 210            //network group
#define tinyTXNode 22         // node ID of the tinyTX to watch
...
void setup () {
 ...
 #ifdef DEBUG 
 Serial.println("TinyTX Receiver");
 Serial.println("----------------------------");
